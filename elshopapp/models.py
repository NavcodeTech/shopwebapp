...
class Product(models.Model):
    ...
    def save(self,*args,**kwargs):
        if self.unique_id is None and self.createdAt and self.id:
            self.unique_id=self.createdAt.strftime('75%Y%m%d23')+str(self.id)
...
class Profile(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    first_name=models.CharField(max_length=20,default="dfg")
    last_name=models.CharField(max_length=20,default="fgd")
    email=models.EmailField(default="sdf")
    dob=models.DateField(default='2001-08-02')
...
class AddressMod(models.Model):
    country_choice={('Australia','Australia'),
    ...
    city_choice = {   ('Ahemdabad', 'Ahemdabad'),
                      ('Cuttack','Cuttack'),
                      ('Bhubaneswar','Bhubbanewsar'),
